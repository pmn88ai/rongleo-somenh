...
import type { PhonePanelInput } from "./types"
  ...
  return (
    <div
      style={{
        ...
        padding: "8px 0",
        borderBottom: "1px solid #0d1620",
        gap: 12,
        minHeight: 36,
        background: index % 2 === 0 ? "transparent" : "#080e18",
      }}
    >
      {/* label */}
...
export function PhonePanel({ group }: PhonePanelInput) {
  return (
    <div style={s.root}>
      ...
      <div style={s.header}>
        <div style={s.dot} />
        <span style={s.title}>Phone Numerology</span>
