...
import type { AstrologyPanelInput } from "./types"
  ...
  return (
    <div
      style={{
        ...
        gap: 12,
        minHeight: 36,
        background: index % 2 === 0 ? "transparent" : "#0b0f17",
      }}
    >
      {/* label */}
...
export function AstrologyPanel({ group }: AstrologyPanelInput) {
  return (
    <div style={s.root}>
      ...
      <div style={s.header}>
        <div style={s.dot} />
        <span style={s.title}>Astrology</span>
